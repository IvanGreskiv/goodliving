  ...
  <article <?php post_class('single-entry-post');?>>
    ...
    <div class="property-details">
      ...
      <div class="property-details-panel entry-content">
        <h3 ><?php _e('Страницы:','colabsthemes');?></h3>
				<ul>
				<?php wp_list_pages('title_li='); ?>
				</ul>
				<h3 ><?php _e('Категории:','colabsthemes');?></h3>
				<ul>
					<?php wp_list_categories('title_li=&hierarchical=0&show_count=1') ?>
				</ul>
				<h3 ><?php _e('Месячный архив:','colabsthemes');?></h3>
				<ul>
					<?php wp_get_archives('type=monthly'); ?>
				</ul>
				<h3 ><?php _e('RSS Лента:','colabsthemes');?></h3>
				<ul>
				...
				<h3 ><?php _e('Удобства недвижимости:','colabsthemes'); ?></h3>
				<ul><?php wp_list_cats('sort_column=name&optioncount=1&hierarchical=0&taxonomy=property_features'); ?></ul>
				<h3 ><?php _e('Тип недвижимости:','colabsthemes'); ?></h3>
				<ul>
				<?php 							
				$args = array(
				...
				<h3 ><?php _e('Расположение','colabsthemes'); ?></h3>
				<ul>
				<?php 							
				$args = array(
