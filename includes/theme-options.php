...
$options[] = array( "name" => __("Contact Agent Label","colabsthemes"),
                    "desc" => __("Specify the text that will be displayed on the Contact Agent button.","colabsthemes"),
                    "id" => $shortname."_contact_agent",
                    "std" => "Contact Agent Now",
                    "type" => "text");					
...
$colabs_metaboxes[] = array (  "name"  => $post_type."_as_featured",
					            "std"  => "false",
					            "label" => __("Featured","colabsthemes"),
					            "type" => "checkbox",
					            "desc" => __("Checked if you want make this property as featured","colabsthemes"));
											
$colabs_metaboxes[] = array (  "name"  => $post_type."_label",
					            "std"  => "",
					            "label" => __("Hover Title","colabsthemes"),
					            "type" => "text",
					            "desc" => __("Enter the text for image hover","colabsthemes"));		
											
$colabs_metaboxes[] = array (  "name"  => $post_type."_address",
					            "std"  => "",
...
$colabs_metaboxes[] = array (  "name"  => $post_type."_agent",
...
$colabs_metaboxes[] = array (  "name"  => $post_type."_price",
					            "std"  => "",
...
$colabs_metaboxes[] = array (  "name"  => $post_type."_beds",
					            "std"  => "",
...
$colabs_metaboxes[] = array (  "name"  => $post_type."_baths",
					            "std"  => "",
...
$colabs_metaboxes[] = array (  "name"  => $post_type."_furnished",
					            "std"  => "false",
...
$colabs_metaboxes[] = array (  "name"  => $post_type."_mortgage",
					            "std"  => "false",
...
$colabs_metaboxes[] = array (  "name"  => "expires",
					            "std"  => "",
