      ...
      <div class="input-slider column col6">
        <div class="price-slider-wrapper">
          ...
          <div class="price-slider-amount">
            <input type="text" class="min-price" id="min_price" name="price_min" data-min="0" placeholder="Min Price" value="<?php if ( $price_min != '' ) { echo $price_min; } ?>">
            <input type="text" class="max-price" id="max_price" name="price_max" data-max="<?php echo $max_price_properties;?>" placeholder="Max Price" value="<?php if ( $price_max != '' ) { echo $price_max; } ?>">
          </div>
        </div>
      </div>
        ...
        <div class="price-slider-wrapper">
          ...
          <div class="price-slider-bg"><div class="price-slider"></div></div>
          <div class="price-slider-amount">
            <input type="text" class="min-price" id="size_min" name="size_min" data-min="0" placeholder="Min Size" value="<?php if ( $size_min != '' ) { echo $size_min; } ?>">
            <input type="text" class="max-price" id="size_max" name="size_max" data-max="<?php echo $max_size_properties;?>" placeholder="Max Size" value="<?php if ( $size_max != '' ) { echo $size_max; } ?>">
          </div>
        </div>
      </div>
