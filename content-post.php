    ...
    <div class="entry-inner">
      ...
      <footer class="entry-footer clearfix">
        <?php the_time(get_option('date_format')); ?></span>&nbsp;/&nbsp;
				<a class="comment-count" href="<?php comments_link(); ?>" title=""><?php comments_number( __('Нет комментариев','colabsthemes'), __('1 комментарий','colabsthemes'), __('% комментариев','colabsthemes') ); ?></a>
      </footer>
    </div>
</article>
